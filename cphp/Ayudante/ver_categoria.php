        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a data-toggle="modal" href="#myModal" class="btn btn-default">Agregar Categoria</a>
                    <br><br>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form role="form" method="post" action="php/php_categoria/agregar.php">
                    ...
                    <?php include "php/php_categoria/tabla.php"; ?>
                </div>
            </div>
        </div>

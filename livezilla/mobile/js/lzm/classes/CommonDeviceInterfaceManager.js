...
IFManager.IFSetOperatorStatus = function(_status) {
    try {
        if (IFManager.IsAppFrame && IFManager.DeviceInterface !== null && d(IFManager.DeviceInterface.setOperatorStatus)) {
            IFManager.DeviceInterface.setOperatorStatus(parseInt(_status));
        }
    } catch (ex) {
        IFManager.IFError(10.6, ex);
    }
};
...
IFManager.IFSetStatus = function(_status) {
    try {

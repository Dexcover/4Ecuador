...
class GeoTracking
{
    ...
    {
        $_toReplace = str_replace("<!--geo_url-->",base64_encode(GeoTracking::GetURL() . "?aid=1&sid=".base64_encode(Server::$Configuration->File["gl_lzid"])."&dbp=".Server::$Configuration->File["gl_gtdb"]),$_toReplace);

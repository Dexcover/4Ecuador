...
function lz_chat_set_input_fields(){
    try
    {
        if(lz_chat_data.InputFieldIndices != null && lz_chat_data.SelectedGroup != null)
        {
            ...
            if(isChat && lz_chat_data.SelectedGroup.Amount == 0 && !OverlayChatWidgetV2.__PublicGroupChat.length)
            {
...
function lz_chat_overlay_set_mode(type,click){
    var showBox;
    if(lz_chats_external && !lz_overlay_chat.m_FullScreenMode)
    {
        ...
        if(lz_ovlel[i].type != 'wm')
        {
            ...
            if(!lz_is_mobile && !lz_overlay_chat.m_FullScreenMode)
            {
                cln.onmouseover = function(){
                    //if(this.dataset.tid==lz_session.OVLWMSElem)
                ...
                cln.onmouseout = function(){
                    ...
                    //document.getElementById(this.dataset.did).style.display='none';
